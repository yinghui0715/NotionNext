...
import { adaptContentLibraryProperties } from './contentLibraryAdapter'
...
export default async function getPageProperties(
  ...
  // Leo Digital Lab uses Content Library as the content source of truth.
  // Normalize its governance-oriented fields into NotionNext's page model
  // without changing or duplicating the source record.
  adaptContentLibraryProperties(properties)
