...
module.exports = {
  ...
  CONTACT_EMAIL: btoa(
    unescape(
      encodeURIComponent(
        process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'liyinghui.cn@outlook.com'
      )
    )
  ), // 公开联系邮箱
  ...
  CONTACT_WECHAT_NAME:
    process.env.NEXT_PUBLIC_CONTACT_WECHAT_NAME || 'Leo数字工坊',
  CONTACT_WECHAT_QR:
    process.env.NEXT_PUBLIC_CONTACT_WECHAT_QR ||
    '/images/leo-digital-lab-wechat.jpg'
}
